...
export default function DashboardWrapper({ children }: DashboardWrapperProps) {
  ...
  return (
    <div
      className={cn(
        "rounded-md flex flex-col md:flex-row bg-gray-100 dark:bg-dark-primary w-full flex-1 mx-auto border border-neutral-200 dark:border-neutral-700",
...
const Dashboard = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className='flex flex-1 bg-card min-h-0'>
      <div className='p-3 md:px-6 md:pt-6 rounded-tl-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col gap-2 flex-1 w-full overflow-y-auto overflow-x-hidden'>
        {children}
      </div>
    </div>
  );
