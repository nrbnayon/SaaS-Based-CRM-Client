...
export const AnalyticsSection = () => {
  // Data for Income Analytics using StackedBarChart format
  const stackedBarData = [
    { day: "Sun", income1: 80, income2: 60 },
    { day: "Mon", income1: 90, income2: 70 },
    { day: "Tue", income1: 100, income2: 80 },
    { day: "Wed", income1: 120, income2: 90, income3: 70 }, // Wednesday has 3 segments
    { day: "Thu", income1: 110, income2: 85 },
    { day: "Fri", income1: 95, income2: 75 },
    { day: "Sat", income1: 140, income2: 60 },
  ];
  ...
  return (
    <div className='flex gap-6'>
        ...
        <CardContent className='p-4 h-80'>
          <ResponsiveContainer width='100%' height='100%'>
            ...
            >
              ...
              />
              {/* Stacked bars - all use same stackId to stack on top of each other */}
              <Bar
                dataKey='income1'
                stackId='income'
                fill='#FCD34D'
      ...
      {/* Category Analytics Card - same as before */}
...
//         { height: "h-[49px]", bg: "bg-yellow-light" },
//       ],
//     },
//     {
//       day: "Mon",
